...
draw_monomial_plot(x_plot, y_true, y_pred_freenet, "FreeNet", degree, coefficient)

x_plot, y_true, y_pred_mlp = get_plotter_values(trained_mlp, degree, coefficient)
draw_monomial_plot(x_plot, y_true, y_pred_mlp, "MLP", degree, coefficient)

x_plot, y_true, y_pred_mlp_sqrelu = get_plotter_values(trained_mlp_sqrelu, degree, coefficient)
draw_monomial_plot(x_plot, y_true, y_pred_mlp_sqrelu, "MLPSqReLU", degree, coefficient)
